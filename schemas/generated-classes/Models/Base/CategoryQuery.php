 ...
 * @method     ChildCategoryQuery orderByUrl($order = Criteria::ASC) Order by the url column
 ...
 * @method     ChildCategoryQuery groupByUrl() Group by the url column
 ...
 * @method     ChildCategory findOneByUrl(string $url) Return the first ChildCategory filtered by the url column
 ...
 * @method     ChildCategory requireOneByUrl(string $url) Return the first ChildCategory filtered by the url column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCategory[]|ObjectCollection findByUrl(string $url) Return ChildCategory objects filtered by the url column
...
abstract class CategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'dofe', $modelName = '\\Models\\Category', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, url, color FROM categories WHERE id = :p0';
        try {
    ...
    public function filterByUrl($url = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_URL, $url, $comparison);
    }
    ...
    public function filterByArticle($article, $comparison = null)
    {
        if ($article instanceof \Models\Article) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_ID, $article->getIdCategory(), $comparison);
