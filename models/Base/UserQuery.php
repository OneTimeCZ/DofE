...
abstract class UserQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, username, email, email_confirmed_at, email_confirm_token, password, password_reset_token, permissions, signin_count, id_image, last_signin_at, created_at, updated_at FROM users WHERE id = :p0';
        try {
